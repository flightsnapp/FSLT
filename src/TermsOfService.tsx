  ...
  <div className="page-container">
    <main className="page-content">
      ...
      <section className="policy-section">
        <h2>
          <i className="fas fa-handshake"></i> 1. Agreement to Terms
        </h2>
        <p>
      ...
      <section className="policy-section">
        <h2>
          <i className="fas fa-globe"></i> 2. Use of Our Services
        </h2>
        <p>
      ...
      <section className="policy-section">
        <h2>
          <i className="fas fa-user"></i> 3. User Responsibilities
        </h2>
        <p>
      ...
      <section className="policy-section">
        <h2>
          <i className="fas fa-rocket"></i> 4. SnappStars Program (If Applicable)
        </h2>
        <p>
      ...
      <section className="policy-section">
        <h2>
          <i className="fas fa-exclamation-triangle"></i> 5. Limitation of Liability
        </h2>
        <p>
      ...
      <section className="policy-section">
        <h2>
          <i className="fas fa-shield-alt"></i> 6. Intellectual Property
        </h2>
        <p>
      ...
      <section className="policy-section">
        <h2>
          <i className="fas fa-gavel"></i> 7. Governing Law
        </h2>
        <p>
          These Terms cruise under the laws of Alberta, Canada—any disputes get resolved through binding arbitration per ADRIC rules there, keeping things smooth and local. Force majeure covers those unexpected layovers!
        </p>
      </section>
      <section className="policy-section">
        <h2>
          <i className="fas fa-sync-alt"></i> 8. Changes to Terms
        </h2>
        <p>
          As we evolve (think new affiliate spins or ML upgrades), we'll refresh these Terms—check back for updates with a new effective date. Continued adventures or SnappStar shines mean you agree to the latest version. We'll notify you of big changes, so the fun never skips a beat!
        </p>
      </section>
    </main>
  </div>
